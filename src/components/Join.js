    ...
    <section className="join-form-container" id="joining-cape">
      <div className="container">
        ...
        <div className="join-text-container">
          ...
          <p>
            <span className="red-text">*</span>indicates response required
          </p>
        </div>
        ...
        {success && (
          <div className="success-form animated-form-notice">
            <h3 className="green-text">
              Thanks! We will look at your request to join and let you know our
              decision.
            </h3>
          </div>
        )}
        {error && (
          <div className="failure-form animated-form-notice">
            <h3 className="red-text">
              Sorry! There has been an error with the form! Refresh the page and
              try again, or contact CAPE directly.
            </h3>
          </div>
        )}
        {!success && !error && (
          <form onSubmit={handleSubmit} className="join-form">
            <p className="join-form--text-label">
              <span className="red-text">*</span>Name
            </p>
            ...
            <p className="join-form--text-label">
              <span className="red-text">*</span>Email
            </p>
            <div className="form-row">
            ...
            <p className="join-form--text">
              <span className="red-text">*</span>Address
            </p>
            <div className="form-row">
              <label className="label-hidden" htmlFor="address">
                Address
              </label>
              <input
                name="address"
            ...
            <div className="form-row">
              <label className="label-hidden" htmlFor="telephone">
                Telephone
              </label>
              <input
                type="text"
            ...
            <p className="join-form--reason-text">
              We welcome new members and would like to know a little about you.
              For example, how will membership be of benefit to you; and how
              would you like to contribute to CAPE activities (specialist
              knowledge or expertise, events organisation, facilities to host
              meetings, particular interests etc)?
            </p>

            <p className="join-form--text">
              <span className="red-text">*</span>What is your work role?
            </p>
            <div className="form-row">
              <label className="label-hidden" htmlFor="yourRole">
            ...
            <p className="join-form--text">
              <span className="red-text">*</span>Why are you interested in
              joining CAPE?
            </p>
            <div className="form-row">
              <label className="label-hidden" htmlFor="whyJoin">
                Why are you interested in joining CAPE?
              </label>
              <input
                type="text"
                name="whyJoin"
            ...
            <div className="form-row">
              <label className="label-hidden" htmlFor="moreInfo">
                Please provide any further information here
              </label>
              <input
                type="text"
            ...
            <p className="join-form--checkbox">
              <span className="red-text">*</span>Condition of membership
            </p>

            <p className="join-form--checkbox inline-elem">
              <span className="red-text">*</span>I agree to abide by the
              principles in the Constitution
            </p>
            <div className="form-row">
              <label className="label-hidden" htmlFor="memberAgreement">
              ...
              <input
                ...
                value={memberAgreement}
                onChange={() => {
                  setMemberAgreement((prevState) => !prevState);
                }}
              />
            </div>
